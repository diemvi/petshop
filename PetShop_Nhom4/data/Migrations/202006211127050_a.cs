namespace data.Migrations
{
    ...
    public partial class a : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ID_KH_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.MaHoaDon)
                .ForeignKey("dbo.AspNetUsers", t => t.ID_KH_Id)
                .Index(t => t.ID_KH_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.HoaDons", "ID_KH_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.ChiTietHoaDons", "MaHoaDon", "dbo.HoaDons");
            DropForeignKey("dbo.SanPhams", "GenreID", "dbo.Genres");
            DropForeignKey("dbo.Comments", "MaSP", "dbo.SanPhams");
            DropForeignKey("dbo.Comments", "AuthorId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.ChiTietHoaDons", "MaSP", "dbo.SanPhams");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.HoaDons", new[] { "ID_KH_Id" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Comments", new[] { "MaSP" });
            DropIndex("dbo.Comments", new[] { "AuthorId" });
            DropIndex("dbo.SanPhams", new[] { "GenreID" });
            DropIndex("dbo.ChiTietHoaDons", new[] { "MaSP" });
